var N3D_API_KEY = ‘n3d_sk_q-FLJrMtYAqgGivAMEgrstEjgZdfQkXG’;
...
var FIREBASE_DESIGNS_URL = ‘https://getdesigns-mglznpa3zq-uc.a.run.app’;
var MY_PHOTOS = {};
...
xhr.open(‘GET’,FIREBASE_DESIGNS_URL,true);
xhr.setRequestHeader(‘X-Api-Key’,N3D_API_KEY);
xhr.timeout=30000;
xhr.onload=function(){
...
xhr.onerror=function(){showError(‘Network error - could not connect’);};
xhr.ontimeout=function(){showError(‘Request timed out after 30s’);};
xhr.send();
}
